...
<nav>
  <Container>
    <div class="flex items-center justify-between pt-10 pb-6 md:pt-12 md:pl-[0.125rem]">
      ...
      <button
        class="peer group z-20 flex min-h-[2.0625rem] cursor-pointer flex-col items-center justify-center gap-1.5 *:h-[0.1875rem] *:w-6 *:shrink-0 *:bg-gray-950 *:transition-transform aria-expanded:gap-0 aria-expanded:*:bg-white md:hidden"
        type="button"
      ...
      <div
        ...
        use:menuAction
      >
        <div class="w-[min(100vw-3rem,25rem)] rounded-lg bg-purple-950 px-6 py-10 md:w-full md:bg-transparent md:p-0">
          <ul
